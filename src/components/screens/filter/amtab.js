        ...
        <View style={[CommonStyles.spaceAround, { flex: 1 }]}>
          ...
          <View style={[CommonStyles.row]}>
            ...
            <View style={[CommonStyles.row, { flex: 0.5 }]}>
              ...
              <View style={[CommonStyles.paddingTen]}>
                <Text tyle={[CommonStyles.regularBold, CommonStyles.greyColor]}>
                  All
                </Text>
              </View>
            </View>
          ...
          <View>
            ...
            >
              <View>
                <Image
                  source={require("../../../assets/img/convertible.png")}
              ...
              <View>
                <Image
                  source={require("../../../assets/img/wagon.png")}
                  style={{ width: 50, height: 50 }}
                />
                <Text
                  style={[CommonStyles.regularBold, CommonStyles.greyColor]}
              ...
              <View>
                <Image
                  source={require("../../../assets/img/all-terrain-vehicle.png")}
                  style={{ width: 50, height: 50 }}
                />
                <Text
                  style={[CommonStyles.regularBold, CommonStyles.greyColor]}
          ...
          <View>
            ...
            >
              ...
              <View>
                <Image
                  source={require("../../../assets/img/minivan.png")}
                  style={{ width: 50, height: 50 }}
                />
                <Text
                  style={[CommonStyles.regularBold, CommonStyles.greyColor]}
              ...
              <View>
                <Image
                  source={require("../../../assets/img/coupe-car.png")}
                  style={{ width: 50, height: 50 }}
                />
                <Text
                  style={[CommonStyles.regularBold, CommonStyles.greyColor]}
          ...
          <View>
            ...
            >
              <View>
                <Image
                  source={require("../../../assets/img/sedan-car-model.png")}
                  style={{ width: 50, height: 50 }}
                />
                <Text
                  style={[CommonStyles.regularBold, CommonStyles.greyColor]}
